...
namespace DAL.DSTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuario] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [" +
                "Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ([Usuario] = @Original_Us" +
                "uario) AND ([Contraseña] = @Original_Contraseña))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuario] ([Nombre], [Usuario], [Contraseña]) VALUES (@Nombre, @Usuar" +
                "io, @Contraseña);\r\nSELECT Id, Nombre, Usuario, Contraseña FROM Usuario WHERE (Id" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuario] SET [Nombre] = @Nombre, [Usuario] = @Usuario, [Contraseña] = @Contraseña WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ([Usuario] = @Original_Usuario) AND ([Contraseña] = @Original_Contraseña));
SELECT Id, Nombre, Usuario, Contraseña FROM Usuario WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DAL.Properties.Settings.Default.TPConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Constraseña", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, null, global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Update(string Nombre, string Usuario, string Contraseña, int Original_Id, string Original_Nombre, string Original_Usuario, string Original_Contraseña, int Id) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Usuario, string Contraseña, int Original_Id, string Original_Nombre, string Original_Usuario, string Original_Contraseña) {
            return this.Update(Nombre, Usuario, Contraseña, Original_Id, Original_Nombre, Original_Usuario, Original_Contraseña, Original_Id);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object ExisteUsuario(string Usuario, string Constraseña) {
            ...
            if ((Constraseña == null)) {
                ...
                command.Parameters[2].Value = ((string)(Constraseña));
            }
