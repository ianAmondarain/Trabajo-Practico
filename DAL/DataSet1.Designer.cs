...
namespace DAL {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuarioRow AddUsuarioRow(int Id, string Usuario, string Contraseña) {
...
namespace DAL.DataSet1TableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuario] WHERE (([Id] = @Original_Id) AND ([Usuario] = @Original_Usu" +
                "ario) AND ([Contraseña] = @Original_Contraseña))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuario] ([Id], [Usuario], [Contraseña]) VALUES (@Id, @Usuario, @Con" +
                "traseña);\r\nSELECT Id, Usuario, Contraseña FROM Usuario WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Usuario] SET [Id] = @Id, [Usuario] = @Usuario, [Contraseña] = @Contraseña" +
                " WHERE (([Id] = @Original_Id) AND ([Usuario] = @Original_Usuario) AND ([Contrase" +
                "ña] = @Original_Contraseña));\r\nSELECT Id, Usuario, Contraseña FROM Usuario WHERE" +
                " (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DAL.Properties.Settings.Default.TPFinalConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Constraseña", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Contraseña", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> ExisteUsuario(string Usuario, string Constraseña) {
            ...
            if ((Constraseña == null)) {
                throw new global::System.ArgumentNullException("Constraseña");
            }
            else {
                command.Parameters[1].Value = ((string)(Constraseña));
            }
